...
export default function StoryWritingPad({ onPostCreated }) {
        ...
        <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
            ...
            {imagePreview && (
                <div className="position-relative mt-3 mb-3">
                    <img src={imagePreview} alt="Preview" className="img-fluid rounded" style={{ maxHeight: '300px', width: '100%', objectFit: 'cover' }} />
                    <button 
            ...
            <input type="file" className="d-none" accept="image/*" ref={fileInputRef} onChange={handleImageChange} />
            ...
            <div className="_feed_inner_text_area_bottom">
                <div className="_feed_inner_text_area_item">
                    ...
                    <div className="_feed_inner_text_area_bottom_article _feed_common dropdown">
                        <button
                            type="button"
                            className="_feed_inner_text_area_bottom_photo_link dropdown-toggle"
                ...
                <div className="_feed_inner_text_area_btn">
                    <button type="button" className="_feed_inner_text_area_btn_link" onClick={handleSubmit} disabled={loading || (!content && !image)}>
                        <svg
                            className="_mar_img"
                            xmlns="http://www.w3.org/2000/svg"
                            width={14}
