        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
                <div className="container _custom_container">
                    ...
                    <div className={`navbar-collapse ${!isDesktop && '--collapse'}`} id="navbarSupportedContent">
                        ...
                        <div className="_header_nav_profile">
                            <div className="_header_nav_profile_image" onClick={() => setIsProfileDropShow(prev => !prev)}>
                                <img
                            ...
                            <div className="_header_nav_dropdown" onClick={() => setIsProfileDropShow(prev => !prev)}>
